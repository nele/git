...
try {
    ...
    ResultSet resultSet = selectStatement.executeQuery(
		   		"Select * from book, condition, language, genre where book.language_langid=language.langid and book.condition_conditionid=condition.conditionid and genre.genreid=book.genre_genreid order by title asc;"
		   );
