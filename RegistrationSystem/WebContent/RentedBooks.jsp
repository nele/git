...
try {
    ...
    ResultSet resultSet = selectStatement.executeQuery(
		   		"Select * from book, condition, language, genre, oorder where book.bookid=oorder.book_bookid and book.language_langid=language.langid and book.condition_conditionid=condition.conditionid and genre.genreid=book.genre_genreid  order by dateinserted desc;"
		   );
        ...
        %> <table border=1> 
             <tr>
               ...
               <td bgcolor=eeeeee><b>Date Inserted</b></td>
                 <td bgcolor=eeeeee><b>Renter</b></td>          
             </tr> 
        <%
